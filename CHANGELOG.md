...
## [5.4.1] - 2026-06-12
### Fixed
- raise an exception when sushi server returns unexpected status code (e.g. 300)

## [5.4.0] - 2026-06-01
### Changed
- only one date format should be used (no fallback)

## [5.3.1] - 2026-04-21
### Added
- handle date checks (strict=True/False) during download phase

## [5.3.0] - 2026-04-20
### Added
- check that when NIGIRI_LONG_DATE_FORMAT_FIRST is not used that entire month is used (based on Report_Filters)

## [5.2.0] - 2026-04-14
### Added
- skip records with date which is out of range (or raise Exception in strict mode)

## [5.1.1] - 2026-04-10

### Fixed
- Report.record_found should be False when report contains all data with wrong date

## [5.1.0] - 2026-03-03

### Added
- nigiri can query /reports endpoints

## [5.0.1] - 2026-01-26

### Fixed
- allow URI title identifier for DR reports

## [5.0.0] - 2026-01-14

### Changed
- updated celus-pycounter to 5.0.0
- drop support for older version of python (oldest supported is 3.12)

## [4.2.2] - 2025-12-15

### Fixed
- make sure that output of regular attempt and fallback won't get mixed
