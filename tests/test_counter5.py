    ...
    def test_record_ir(self):
        ...
        assert [e.as_csv() for e in records] == [
            (
                ...
                "Access_Method:Regular|Access_Type:Controlled|Article_Version:VoR|Data_Type:Article|Platform:Platform1|Publisher:MyPublisher|YOP:2019",
            ...
            (
                ...
                "Access_Method:Regular|Access_Type:Controlled|Article_Version:VoR|Data_Type:Article|Platform:Platform1|Publisher:MyPublisher|YOP:2018",
                "Total_Item_Investigations",
                "2",
            ),
            (
            ...
            (
                ...
                "Article2",
                "DOI:10.2222/222.2222222222222222|Online_ISSN:2222-2222|Print_ISSN:2222-2222|Proprietary:XXXX:22222222-222222222-22222",
                "Access_Method:Regular|Access_Type:Controlled|Article_Version:VoR|Data_Type:Article|Platform:Platform2|Publisher:MyPublisher|YOP:2018",
                "Total_Item_Investigations",
                "3",
            ),
            (
